    ...
    return (
        ...
        <div className='flex flex-row justify-between py-10 px-10 item-center'>
            ...
            <div className="relative w-full w-100 mx-auto bg-white rounded-full">
            ...
            <div className="relative w-full max-w-xl mx-auto bg-white rounded-full">
                <input placeholder="Search here" className="rounded-lg w-full h-16 bg-transparent py-2 pl-8 pr-32 outline-none border-2 border-gray-100 shadow-md hover:outline-none focus:ring-teal-200 focus:border-teal-200" type="text" name="query" id="query"/>
                <button type="submit" className="absolute inline-flex items-center h-10 px-4 py-2 text-sm text-balck hover:text-white transition duration-150 ease-in-out rounded-full outline-none right-3 top-3 bg-gray-100 sm:px-6 sm:text-base sm:font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 ">
    ...
    <div className="group m-2 mt-5">
        ...
        <div
            ...
            <div className="py-1">
                <Link href='/'><div  className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Consumer</div></Link>
                <Link href='/components/admin'><div  className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Admin</div></Link>
