...
{/* <!-- component --> */}
<div class="flex h-screen m-5 shadow-lg">
  {/* <!-- Left Pane --> */}
  <div class="hidden lg:flex items-center justify-center flex-1 bg-white text-black w-full  ">
    <div class="max-w-lg w-full h-3/4 text-center">
      <img className='w-full h-full object-contain' src="https://en.pimg.jp/082/960/318/1/82960318.jpg" alt="" />
    </div>
  </div>
  {/* <!-- Right Pane --> */}
  <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center m-5 shadow-md">
