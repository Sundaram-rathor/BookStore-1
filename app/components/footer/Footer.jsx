...
function Footer() {
  return (
              ...
              <svg version="1.1" viewBox="0 0 3368 512" xmlns="http://www.w3.org/2000/svg">
                <g fill="none" fill-rule="evenodd">
                  <g transform="translate(0 -75)">
                    ...
                    <text fill="white"   font-size="512" font-weight="300">
                      <tspan x="654" y="518">BookStore</tspan>
                    </text>
                  </g>
                </g>
              </svg>
    ...
    <div class="bg-gray-700 py-4 text-gray-100">
      <div class="container mx-auto px-4">
        <div class="-mx-4 flex flex-wrap justify-between">
          <div class="px-4 w-full text-center sm:w-auto sm:text-left">
            Copyright © 2020
            <script>new    2020 && document.write("- " + new Date().getFullYear())</script>- 2022
